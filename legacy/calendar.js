function calendar(_date, left, top, callback){
			...
			var left = left||100;
			var top = top||100;
			var calendarHtml = '<div id="calendar"><div id="calendarHeader">Выбор даты</div> <div style="height:300px;"> <div id="daysBlock" class="floatLeft" style="width:250px;"> </div> <div id="monthsBlock" class="floatLeft" style="width:150px;"> </div> <div id="yearsBlock" class="floatLeft" style="width:70px;"> </div>  </div> <hr>Время<br><div> <select id="hourSelector"> </select> : <select id="minuteSelector"> </select> </div> <div>Выбираемая дата:<div id="dateToApply"> </div> <input id="okButton" type="button" value="Ок"> <input id="closeButton" type="button" value="Отменить"></div> </div>';
			...
			this.ok=function(){
				_date.years(tempDate.years());
				_date.months(tempDate.months());
