...
var sqFl=[];
	sqFl[0]=["Любая",0,10000];
	sqFl[1]=["менее 35 м<sup>2</sup>",0,35];
	sqFl[2]=["36-70 м<sup>2</sup>",36,70];
	sqFl[3]=["71-110 м<sup>2</sup>",71,110];
	sqFl[4]=["более 110 м<sup>2</sup>",110,10000];
	sqFl[100]=["Любая",0,10000];
	sqFl[101]=["менее 20 соток",0,20];
	sqFl[102]=["20-70 соток",21,70];
	sqFl[103]=["более 70 соток",71,10000];
var objType=[];
	objType[0]='Квартира';
	objType[1]='Участок';
	objType[2]='Дом';
