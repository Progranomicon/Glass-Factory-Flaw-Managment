...
<body>
	...
	<div id="params">
		...
		Тип транспорта <div id="transport" style="display:inline-block"></div><br>
		<div>
		...
		<input type="button" onclick="getStatistic()" value="Формирование паспорта">
	</div>
	...
	<script type="text/javascript">
		...
		$(document).ready(function(){
			...
			el('passport').style.display = 'none';
			updateDate();
		});
	</script>
</body>
