...
if (isset($_POST['M'])){
	...
	$q="SELECT * FROM steklo.ppr Where TODate>'".$_POST['Y']."-".$_POST['M']."-01 00:00:00' AND TODate<'".$_POST['Y']."-".$_POST['M']."-25 23:59:59' and TOArea='".$_POST['Area']."'";
	$res=mysql_query($q);
	if(mysql_num_rows($res)<2){
		$q="INSERT INTO steklo.ppr(CDate, TODate, TOArea, Equipment, EqNum, TONum, Comments, Executor) VALUES ";
