...
<html>
<head>
	<title>РСЗ. Botero и его друзья</title>
...
<body>
	...
	<div class="statDiv">
	Всего капель: <span id="cuttedSpan">0</span>, всего капель сборошено: <span id="ejectedSpan">0</span>, всего изделий сброшено: <span id="ejectedWareSpan">0</span><br>
	Производительность машины: <span id="performanceSpan"></span>
	</div>
	<h3>Графики</h3>
