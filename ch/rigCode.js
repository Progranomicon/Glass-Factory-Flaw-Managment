...
function getStatsData(date1, date2){
		$.ajax('chData.php',{type:"GET", data:{date1:date1, date2:date2,},success:statDataReciever, error:error_handler});
	}
function statDataReciever(data){
	...
	if(dataObj['16']){
		el('cuttedSpan').innerHTML = dataObj['16'][0]; 
		el('ejectedSpan').innerHTML = dataObj['16'][0] - dataObj['16'][2];
		perf = dataObj['16'][2] / dataObj['16'][0] * 100;
