...
function generate(){
	...
	for(var i=numStart;i<numEnd;i++){
		...
		labels.innerHTML+=tmpLabel.replace(new RegExp("%line%",'g'),lines[line].name).replace(new RegExp("%pn%",'g'),zeroinator(i)).replace(new RegExp("111111233334444",'g'),getBarcode(date,line,zeroinator(i)))+"<br>";
		if (parity){
...
function getSap(code){
	...
	if(excelProduction[code].sap!=""){
		result='<span class="">SAP '+excelProduction[code].sap+'</span><br>Номер производственной партии <span class="">'+date+'</span><br>Срок годности <span class="">до '+moment(date, "DDMMYY").add(1, 'years').format("DD.MM.YYYY")+' г.</span>';
	}
	return result;
}
...
//var labelPattern='<div class="label"> <div class="labelTop"> <div class="labelTopProductNum"><img style="display:inline-block;padding-left:0.9cm;padding-right:0.3cm;padding-Top:0.5cm" alt="" src="img/gd.png" width="150" height="80"></img> </div>  <div class="address"> <b><span style="font-size:18px;">ООО "Стекольная компания "РАЗВИТИЕ"</span><br></b>	</div> </div>	 <div class="labelBottomLeft"> <img class="verticalLeftBarcode" alt="Barcode-Result" src="/../barcode.php?print=1&code=111111233334444&scale=2&mode=png&encoding=128&random=50027175"></img><br> <img style="margin-top:3cm;margin-left:-1cm;" alt="3 icons" src="img/3icon.jpg"></img> </div>	 <div class="labelBottomCenter"> <div class="labelProductName"> <span  class="title"><b>%sName%</b></span><br> <span  style="font-size:20px">%fullName%</span> </div> <div class="labelProductDetails"> <b>%target%</b><br> <div class="sto">СТО 38772188-002-2020</div><br> Цвет стекла: <span class="mediumFont">%color%</span><br> Количество изделий в ряду <span class="mediumFont">%rowCount%</span><br> В паллете <span class="mediumFont">%count%</span><br> Номер м/линии <span class="mediumFont">%line%</span><br> Тип упаковки:<span style="font-size:1.5em"><b>%boxing%</b></span><br> Габаритные размеры:<span style="font-size:1.1em"><b>1000х1200х%h%</b></span><br> Процесс: <b>%proc%</b><br> %sap% </div>	 <div class="labelPalletDate"> <img class="horizontalBarcode" alt="Barcode-Result" src="/../barcode.php?print=1&code=111111233334444&scale=2&mode=png&encoding=128&random=50027175"></img><br> <span style="font-size:36px">%date%</span><br> <span>дата</span><br> <span style="font-size:56px">%pn%</span><br> <span>номер паллета</span> </div> <hr> <div> <div class="address"> Российская федерация</span><br> Республика Мордовия, г. Рузаевка,<br> ул. Станиславского, д. 22, офис 47<br> Телефон: +7 (963)147-22-62<br> E-mail: razvitie2019@mail.ru <br>ййй </div> <img style="display:inline-block;padding-left:0.2cm;padding-right:0.2cm" alt="" src="img/rsz.png"></img> <div class="iso"> ГОСТ ISO 9001-2011, ГОСТ Р ИСО 22000-2007,<br> ГОСТ Р ИСО 14001-2007<br> Сертификат соответствия <br>№РОСС RU.31010.04ЖЗМ0/ОС-01-02099-2015 от 20.11.2015<br><br> </div> </div> </div>         <div class="labelBottomRight" id="pics"> %glPic%<br> <img  alt="var img" src="img/EAC.png"></img><br> <img  alt="var img" src="img/cir.png"></img><br> </div> </div>'; 
 
 var labelPattern='<div class="label"> <div class="labelTop"> <div class="labelTopProductNum"><img style="display:inline-block;padding-left:0.1cm;padding-right:0.3cm;padding-Top:0.5cm" alt="" src="img/gd.png" width="180" height="80"></img> </div>  <div class="address"> <b><span style="font-size:18px;">ООО "Стекольная компания "РАЗВИТИЕ"</span><br><br><br><br></b>	</div>  </div>	 <div class="labelBottomLeft"> <img class="verticalLeftBarcode" alt="Barcode-Result" src="/../barcode.php?print=1&code=111111233334444&scale=2&mode=png&encoding=128&random=50027175"></img><br> <img style="margin-top:3cm;margin-left:-1cm;" alt="3 icons" src="img/3icon.jpg"></img> </div>	 <div class="labelBottomCenter"> <div class="labelProductName"> <span  class="title"><b>%sName%</b></span><br> <span  style="font-size:20px">%fullName%</span> </div> <div class="labelProductDetails"> <b>%target%</b><br> <div class="sto"<b>СТО 38772188-002-2020</b></div><br> Цвет стекла: <span class="mediumFont">%color%</span><br> Вес паллета <span class="mediumFont">%vespaleta%</span><br> В паллете <span class="mediumFont">%count%</span><br> Номер м/линии <span class="mediumFont">%line%</span><br> Тип упаковки:<span style="font-size:1.5em"><b>%boxing%</b></span><br> Габаритные размеры:<span style="font-size:1.1em"><b>1000х1200х%h%</b></span><br> Процесс: <b>%proc%</b><br> %sap% </div>	 <div class="labelPalletDate"> <img class="horizontalBarcode" alt="Barcode-Result" src="/../barcode.php?print=1&code=111111233334444&scale=2&mode=png&encoding=128&random=50027175"></img><br> <span style="font-size:36px">%date%</span><br> <span>дата</span><br> <span style="font-size:56px">%pn%</span><br> <span>номер паллета</span> </div> <hr> <div> <img alt="var img" src="img/ldpe.png" style="height: 43px;"> <img alt="var img" src="img/pap.png" style="height: 43px;"> <img alt="var img" src="img/cir.png" style="padding-top: 15px;border-right-style: solid;border-right-width: 0px;padding-right: 15px;"> <div class="address" > Российская федерация</span><br> Республика Мордовия, г. Рузаевка,<br> ул. Станиславского, д. 22, офис 47<br> Телефон: +7 (963)147-22-62<br> E-mail: razvitie2019@mail.ru <br> Сертификат соответствия <br> ГОСТ Р ИСО 9001-2015, ГОСТ Р ИСО 22000-2019 <br> № HCC-RU-MP47-K-000193-21 от 01.07.2021 г. </div>  <div class="labelBottomRight" id="pics"> %glPic% <img  alt="var img" src="img/EAC.png"></img><img  alt="var img" src="img/cir.png"></img> </div> </div> </div>          </div>'; 
  ...
  /*<div class="label">
	...
	<div class="labelBottomLeft">
		<img class="verticalLeftBarcode" alt="Barcode-Result" src="/../barcode.php?print=1&code=111111233334444&scale=2&mode=png&encoding=128&random=50027175"></img><br>
	...
	<div class="labelBottomCenter">
		...
		<div class="labelPalletDate">
			<img class="horizontalBarcode" alt="Barcode-Result" src="/../barcode.php?print=1&code=111111233334444&scale=2&mode=png&encoding=128&random=50027175"></img><br>
		...
		<div>
			...
			<img style="display:inline-block;padding-left:0.2cm;padding-right:0.2cm" alt="" src="img/rsz.png"></img>
			<div class="iso">
				ГОСТ ISO 9001-2011, ГОСТ Р ИСО 22000-2007,<br>
				ГОСТ Р ИСО 14001-2007<br>
				Сертификат соответствия <br>№РОСС RU.31010.04ЖЗМ0/ОС-01-02099-2015 от 20.11.2015<br><br>
			</div>
		</div>
	</div>
	<div class="labelBottomRight" id="pics">
		%glPic%<br>
		<img  alt="var img" src="img/EAC.png"></img><br>
		<img  alt="var img" src="img/cir.png"></img><br>
	</div>
</div>';*/
