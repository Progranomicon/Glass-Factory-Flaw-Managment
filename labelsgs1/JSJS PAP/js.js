...
function getSap(code){
	...
	if(excelProduction[code].sap!=""){
		result='<span class="">SAP '+excelProduction[code].sap+'</span><br>Номер производственной партии <span class="">2</span><br>Срок годности <span class="">до '+moment(date, "DDMMYY").add(1, 'years').format("DD.MM.YYYY")+' г.</span>';
	}
	return result;
}
